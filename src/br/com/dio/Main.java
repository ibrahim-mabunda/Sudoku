...
public class Main {
    ...
    public static void main(String[] args) {
        final var positions = parseArguments(args);
        while (true) {
            showMenu();
        ...
        for (int i = 0; i < BOARD_LIMIT; i++) {
            ...
            for (int j = 0; j < BOARD_LIMIT; j++) {
                ...
                if (positionConfig == null) {
                    spaces.get(i).add(new Space(0, false)); // Default values
                    continue;
                }
    ...
    private static void inputNumber() {
        ...
        var col = getCoordinate("Informe a coluna em que o número será inserido");
        var row = getCoordinate("Informe a linha em que o número será inserido");
    ...
    private static void removeNumber() {
        ...
        var col = getCoordinate("Informe a coluna do número a ser removido");
        var row = getCoordinate("Informe a linha do número a ser removido");
    ...
    private static int getCoordinate(String message) {
